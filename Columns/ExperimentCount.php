...
class ExperimentCount extends Dimension
{
     ...
     * @var string
     */
    protected $columnName = 'experiment_id';
    protected $columnType = 'INT DEFAULT NULL';
    ...
    protected $sqlSegment = 'log_visit.experiment_id';
    ...
    {
        $paramValue = Common::getRequestVar('sabi', '', 'int', $request->getParams());
        if (!empty($paramValue)) {
            return $paramValue;
        }
        return false;
